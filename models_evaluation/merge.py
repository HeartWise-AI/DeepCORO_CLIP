...
# ===== CONFIGURATION =====
predictions_csv = "/volume/Deep-Coro-final-branch/outputs/DeepCORO_video_linear_probing/DeepCORO_video_linear_probing_multiview_improved_cls_token/20260120-210406_no_wandb/predictions/inference_predictions_epoch_-1.csv"  # ← À CHANGER
labels_csv = "/volume/Deep-Coro-final-branch/data/CTO_THROMBUS_STENOSIS_70_CALCIF_inference.csv"            # ← À CHANGER
output_dir = "/volume/Deep-Coro-final-branch/mes_scripts/jd"
# ========================
